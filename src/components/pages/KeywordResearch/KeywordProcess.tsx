import {
  ...
  interface KeywordProcessProps {
    isProcessing: boolean;
    progress: number; // 0 to 100
  }
  
  const KeywordProcess = ({ isProcessing, progress }: KeywordProcessProps) => {
          ...
          <VStack spacing={6}>
            ...
            {progress < 100 && (
              <>
                ...
                Please keep this tab open. This usually takes <b>3–5 minutes</b>.
                </Text>
